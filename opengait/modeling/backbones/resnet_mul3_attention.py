...
class resnet_mul3_attention(ResNet):
    def __init__(self, block, channels=[64, 128, 256, 512], in_channel=1, layers=[1, 2, 2, 1], strides=[1, 2, 2, 1],
        ...
        super(resnet_mul3_attention, self).__init__(block, layers)
        ...
        self.attention1 = ELA(128,phi='T')
        self.attention2 = ELA(256,phi='T')
        self.attention3 = ELA(512,phi='T')
        self.attention4 = ELA(512,phi='T')
